...
const TwoWheelerLoan = () => {
  const [selectedAccount, setSelectedAccount] = useState("2wheelerLoan");
  const [sliderValues, setSliderValues] = useState({
    personalLoanOption1: 7000, 
    personalLoanOption2: 6,   
    personalLoanOption3: 9,   
  });
  ...
  return (
    ...
    <div className="w-full h-fit mt-16 bg-gradient-to-t from-white to-gray-300 flex flex-col">
      ...
      <div className="flex justify-around cursor-pointer lg:mt-10 mt-3">
        <div className=" lg:w-64 w-80 text-white font-bold flex justify-center items-center h-12 bg-red-800 mt-10  rounded-full">
        ...
        <div className="flex justify-start ml-5 h-20 w-36 md:w-72">
          <p className="text-red-800 mt-10 font-bold text-lg">
            View 2-wheeler Loan Interest rate
          </p>
        </div>
